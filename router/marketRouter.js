...
const { marketDashboard, approveData, getAllMarket, searchInMarket, getMarketById, login, register, deleteMarket, updataAccount, forgotPassword, resetPassword } = require('../controllers/marketController');
